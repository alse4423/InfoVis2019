function main()
{
    ...
    {
        var S = i / 255.0; // [0,1]
        var R = 1;//Math.max( Math.cos( S * Math.PI ), 0.0 );
        var G = Math.max( Math.cos( 0.6 * S * Math.PI ), 0.0 );
        var B = Math.max( Math.cos( 0.6 * S * Math.PI ), 0.0 );
    ...
    {
        var id = faces[i];
        var Ss0 = scalars[ id[0] ] - Math.min(scalars[ id[0] ], scalars[ id[1] ], scalars[ id[2] ]);
        var Ss1 = scalars[ id[1] ] - Math.min(scalars[ id[0] ], scalars[ id[1] ], scalars[ id[2] ]);
        var Ss2 = scalars[ id[2] ] - Math.min(scalars[ id[0] ], scalars[ id[1] ], scalars[ id[2] ]);
        S0 = Math.round( 255 / Math.max( Ss0, Ss1, Ss2 ) * Ss0 );
        S1 = Math.round( 255 / Math.max( Ss0, Ss1, Ss2 ) * Ss1 );
        S2 = Math.round( 255 / Math.max( Ss0, Ss1, Ss2 ) * Ss2 );
